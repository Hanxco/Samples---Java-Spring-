...
public class Configuracion {
	...
	public DataSource dataSource() {
		...
		ds.setDriverClassName("com.mysql.cj.jdbc.MysqlDataSource");
		ds.setUrl("jdbc:mysql://localhost:3306/bbdd_12_jpa?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
		ds.setUsername("root");
		ds.setPassword("root");
		return ds;
	}
